...
class AddBrachRequestBody{
  ...
  AddBrachRequestBody({required this.name, required this.location, required this.description, required this.coordinates});

  Map<String, dynamic> toJson() => _$AddBrachRequestBodyToJson(this);
  factory AddBrachRequestBody.fromJson(Map<String, dynamic> json) => _$AddBrachRequestBodyFromJson(json);
}
@JsonSerializable()
class LocationFrameLatLng{
  ...
  factory LocationFrameLatLng.fromJson(Map<String, dynamic> json) => _$LocationFrameLatLngFromJson(json);
}